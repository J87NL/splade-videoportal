            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <x-splade-form
                            action="{{ route('admin.dances.update', ['dance' => $dance]) }}"
                            method="patch"
                            :default="$dance"
                            class="space-y-4"
                        >
                            ...
                            <Link v-if="!modal" href="{{ route('admin.dances.index') }}" class="btn btn-info">{{ __('Cancel') }}</Link>
                        </x-splade-form>

                        <x-splade-form
                            action="{{ route('admin.dances.destroy', ['dance' => $dance]) }}"
                            method="delete"
                            confirm
